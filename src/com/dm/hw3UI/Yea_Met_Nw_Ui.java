...
public class Yea_Met_Nw_Ui extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Yea_Met_Nw_Ui() {
		this.setTitle("Clustering Analysis for Yeast Metabolic Network");
		...
		JLabel lblNewLabel = new JLabel(
				"Run Custering Analysis (MCL)  for Yeast Metabolic Network :");
		...
		JLabel lblBestResultWas = new JLabel("Best Result was observed for Inflation Parameter = 1.205");
		lblBestResultWas.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblBestResultWas.setBounds(52, 88, 470, 30);
		panel.add(lblBestResultWas);
		
		JLabel lblThe = new JLabel("The .clu file can be found at ProjectFolder\\pajekCluFiles\\yeast_undirected_metabolic.net.clu");
		lblThe.setVerticalAlignment(SwingConstants.TOP);
		lblThe.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblThe.setBounds(52, 356, 556, 20);
		panel.add(lblThe);
		
		JLabel lblThenetFile = new JLabel("The .net file can be found at ProjectFolder\\pajekNetFiles\\yeast_undirected_metabolic.net");
